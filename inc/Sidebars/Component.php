 ...
 * * `uc_execution()->is_primary_sidebar_active()`
 * * `uc_execution()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			[
				'name'          => esc_html__( 'Sidebar', 'uc-execution' ),
				'id'            => static::PRIMARY_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Add widgets here.', 'uc-execution' ),
		...
		register_sidebar(
			[
				'name'          => esc_html__( 'Footer widgets', 'uc-execution' ),
	...
	/**
	 * Checks whether the footer widget area is active.
	 *
	 * @return bool True if the footer widget area is active, false otherwise.
	 */
