 ...
 * * `uc_execution()->the_comments( array $args = [] )`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function the_comments( array $args = [] ) {
		...
		$amp_live_list = uc_execution()->using_amp_live_list_comments();
		...
		if ( $amp_live_list ) {
			...
			?>
				<div update>
					<button class="button" on="tap:amp-live-comments-list-<?php the_ID(); ?>.update"><?php esc_html_e( 'New comment(s)', 'uc-execution' ); ?></button>
				</div>
			</amp-live-list>
			<?php
		}
