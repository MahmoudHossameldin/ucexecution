...
// Show author only if the post type supports it and not page.
if ( post_type_supports( $post_type_obj->name, 'author' ) && ! is_page() ) {
...
<div class="entry-meta">
	...
	if ( ! empty( $time_string ) ) {
		...
		<span class="posted-on">
			...
			printf(
				...
				esc_html_x( 'Posted on %s', 'post date', 'uc-execution' ),
	...
	if ( ! empty( $author_string ) ) {
		...
		<span class="posted-by">
			...
			$author_byline = _x( 'By %s', 'post author', 'uc-execution' );
			if ( ! empty( $time_string ) ) {
				/* translators: %s: post author */
				$author_byline = _x( 'by %s', 'post author', 'uc-execution' );
			}
	...
	if ( ! empty( $parent_string ) ) {
		...
		<span class="posted-in">
			...
			$parent_note = _x( 'In %s', 'post parent', 'uc-execution' );
